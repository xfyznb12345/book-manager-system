  ...
  (0, _vuex.mapMutations)(['login'])), {}, {
    startLogin: function startLogin(e) {var _this = this;return _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var req, res;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:if (!
                ...
                req = {
                  ...
                  _this.$api.login(req).catch(function (err) {
                    console.log(err);
                  }));case 13:res = _context.sent;
                if (res) {
                  uni.showToast({
                    icon: 'success',
                    position: 'bottom',
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _login_vue_vue_type_template_id_b237504c___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./login.vue?vue&type=template&id=b237504c& */ 100);
